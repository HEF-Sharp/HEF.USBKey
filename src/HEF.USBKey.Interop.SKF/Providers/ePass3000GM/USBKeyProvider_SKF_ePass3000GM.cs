...
{
    public class USBKeyProvider_SKF_ePass3000GM : USBKeyProvider_SKF_Base, IUSBKeyProvider_SKF
    {
        public const string SKF_ProviderName = "ePass3000GM";
        ...
        {
            return Native_SKF_ePass3000GM.SKF_ChangePIN(hApplication, ulPINType, szOldPin, szNewPin, out pulRetryCount);
        }

        protected override uint Native_SKF_VerifyPIN(IntPtr hApplication, uint ulPINType, string szPin, out uint pulRetryCount)
        {
            return Native_SKF_ePass3000GM.SKF_VerifyPIN(hApplication, ulPINType, szPin, out pulRetryCount);
        }
        #endregion
    }
}
