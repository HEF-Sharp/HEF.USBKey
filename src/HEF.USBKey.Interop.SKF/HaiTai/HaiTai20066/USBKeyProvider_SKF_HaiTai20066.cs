...
{
    public class USBKeyProvider_SKF_HaiTai20066 : USBKeyProvider_SKF_Base, IUSBKeyProvider_SKF
    {
        public const string SKF_ProviderName = "HaiTai20066";
        ...
        {
            return Native_SKF_HaiTai20066.SKF_ChangePIN(hApplication, ulPINType, szOldPin, szNewPin, out pulRetryCount);
        }

        protected override uint Native_SKF_VerifyPIN(IntPtr hApplication, uint ulPINType, string szPin, out uint pulRetryCount)
        {
            return Native_SKF_HaiTai20066.SKF_VerifyPIN(hApplication, ulPINType, szPin, out pulRetryCount);
        }
        #endregion
    }
}
